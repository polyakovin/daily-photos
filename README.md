...
В просмотрщике снимок также можно отметить как фото месяца или года. При работе с выбранной папкой эти отметки хранятся в файле `period_photo_selections.json` в корне самой папки, поэтому переносятся вместе с архивом. В режиме автоматического поиска по компьютеру файл хранится в системном профиле приложения.
